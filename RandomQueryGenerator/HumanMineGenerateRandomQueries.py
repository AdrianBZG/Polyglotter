...
class HumanMineGenerateRandomQueries(GenerateRandomQueries):
...
if __name__ == "__main__":
    ...
    for training_set_size in training_set_sizes:
        ...
        trainingDataSaveDir = "../Data/TrainingData/HumanMine/" + str(number_of_runs) + "/"
        generation_runs = HumanMineGenerateRandomQueries.generateQuery(training_data_save_dir = trainingDataSaveDir,
